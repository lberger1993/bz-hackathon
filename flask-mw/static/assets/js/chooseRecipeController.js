                ...
                if ($scope.Foodrecipes[element]['RecipeID'] == recipe_id) {
                    for (var val in $scope.Foodrecipes[element]['FoodItems']) {
                        ...
                        $scope.alternatives.push({
                            'id': $scope.Foodrecipes[element]['FoodItems'][val]['FoodIemID'],
                            'alternates': $scope.Foodrecipes[element]['FoodItems'][val]['Alternative'],
                            'water_scores': $scope.Foodrecipes[element]['FoodItems'][val]['AlternativeAmountInRecipe']
                        });
